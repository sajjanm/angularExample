...
'use strict';
	...
	.controller('AdminProfileModalController', AdminProfileModalController);

	AdminProfileModalController.$inject = ['$uibModalInstance', 'profile', 'showBasicDetails'];

	function AdminProfileModalController($uibModalInstance, profile, showBasicDetails) {
	    var vm = this;
	...
	} // end of admin profile modal controller
