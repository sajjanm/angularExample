(function() {
    ...
    AdminController.$inject = ['AdminService', 'AdminProfileService', '$uibModal', 'NgTableParams', 'PaginationService', 'ValidationService'];

    function AdminController(AdminService, AdminProfileService, $uibModal, NgTableParams, PaginationService, ValidationService) {
        var vm = this;
        ...
        function getAllAdminsTable() {
            ...
            },
            {
                ...
                getData : function( $defer, params){
                    ...
                    AdminService.getAllAdminsByPagination(tableParams).then(
        ...
        function createAdmin(form) {
            ...
            AdminService.createAdmin(vm.admin)
            .then(function(successResponse){
                vm.formData = true;
                vm.success = true;
        ...
        function editAdmin(adminToUpdate) {
            ...
            AdminService.editAdmin(adminToUpdate.id)
            .then(function(successResponse) {
        ...
        function updateAdmin(form_object) {
            ...
            AdminService.updateAdmin(admin, admin.id)
            .then(function(successResponse){
                vm.editView = false;
                vm.success = true;
                vm.success_message = successResponse.data.message;
        ...
        function deleteAdmin(admin, admin_id) {
            resetError();
            AdminService.deleteAdmin(admin, admin_id)
            .then(function(successResponse){
                vm.success = true;
                vm.success_message = successResponse.data.message;
